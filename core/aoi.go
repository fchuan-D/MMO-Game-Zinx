...
// GetSurroundGridsByGid 根据格子 GID得到周围九宫格格子集合
...
// AddPidToGridByGid 添加一个 playerID到一个格子中
func (m *AOIManager) AddPidToGridByGid(pid, gid int) {
	m.Grids[gid].Add(pid)
}

// AddPidToGridByPos 通过坐标将 playerID添加到对应格子中
